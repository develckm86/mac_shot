...
![範囲キャプチャ](docs/images/ja/03-region.png)
...
![スクリーンショットツール](docs/images/ja/02-toolbar.png)
...
![オプション](docs/images/ja/04-options.png)
...
![収録中の表示](docs/images/ja/05-recording.png)
...
![フローティングサムネール](docs/images/ja/06-thumbnail.png)
...
![起動時の案内](docs/images/ja/01-guide.png)
...
タスクバーの上に通知くらいの小さなバナーが右からスライドして現れ、9 秒で消えます。

![広告バナー](docs/images/ja/08-ad.png)

- 上部に必ず広告表示と ✕ が付いています。
- キャプチャが始まる前にバナーを片付けます — **撮った画像や録画には写りません。**
- キャプチャを妨げません。インターネットに繋がっていなければ枠だけが表示されます。
